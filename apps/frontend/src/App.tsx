      ...
      <main className="min-h-screen bg-[radial-gradient(circle_at_12%_15%,#223046,transparent_40%),radial-gradient(circle_at_85%_10%,#3b1e2e,transparent_35%),linear-gradient(135deg,#0b0f1a,#121826)] text-slate-100">
        <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col gap-12 px-6 py-12">
          ...
          <header className="relative z-10 flex flex-wrap items-center justify-between gap-4">
            <div className="text-sm uppercase tracking-[0.3em] text-slate-400">Webster</div>
          ...
          <section className="relative z-10 grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lg text-slate-300">
                Start a new project, jump into the editor, or open templates for a faster launch.
              </p>
              ...
              <div className="mt-10 grid gap-4 text-sm text-slate-300 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-700/60 bg-slate-900/40 p-4">
                  ...
                  <p className="mt-2">Create projects in minutes with the editor and templates.</p>
                </div>
                <div className="rounded-2xl border border-slate-700/60 bg-slate-900/40 p-4">
                  <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Session ready</p>
                  <p className="mt-2">Your account stays signed in with secure cookies.</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-slate-700/60 bg-slate-900/50 p-6 shadow-[0_20px_60px_rgba(8,12,22,0.5)]">
              ...
              <p className="mt-1 text-sm text-slate-400">Live API and database connection.</p>
          ...
          <section className="relative z-10">
            <div className="flex items-center justify-between">
              ...
              <Link className="text-sm text-slate-300 hover:text-white" to="/projects">
                View all
              </Link>
            </div>
